...
Esses arquivos são referências para seleção e não contêm tempos de execução aprovados. Um tempo só fica disponível às oficinas depois de o administrador vincular veículo e operação, informar o intervalo de anos, a quantidade de horas e a fonte técnica e publicar o registro na coleção `labor_time_catalog`.
